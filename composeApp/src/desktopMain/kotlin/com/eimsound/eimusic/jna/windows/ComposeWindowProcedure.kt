package com.eimsound.eimusic.jna.windows
...
import com.eimsound.eimusic.jna.windows.structure.MENUITEMINFO
import com.eimsound.eimusic.jna.windows.structure.WinUserConst
import com.eimsound.eimusic.jna.windows.structure.WinUserConst.HTBOTTOM
import com.eimsound.eimusic.jna.windows.structure.WinUserConst.HTBOTTOMLEFT
import com.eimsound.eimusic.jna.windows.structure.WinUserConst.HTBOTTOMRIGHT
import com.eimsound.eimusic.jna.windows.structure.WinUserConst.HTCAPTION
import com.eimsound.eimusic.jna.windows.structure.WinUserConst.HTLEFT
import com.eimsound.eimusic.jna.windows.structure.WinUserConst.HTRIGHT
import com.eimsound.eimusic.jna.windows.structure.WinUserConst.HTTOP
import com.eimsound.eimusic.jna.windows.structure.WinUserConst.HTTOPLEFT
import com.eimsound.eimusic.jna.windows.structure.WinUserConst.HTTOPRIGHT
import com.eimsound.eimusic.jna.windows.structure.WinUserConst.WM_ACTIVATE
import com.eimsound.eimusic.jna.windows.structure.WinUserConst.WM_NCCALCSIZE
import com.eimsound.eimusic.jna.windows.structure.WinUserConst.WM_NCHITTEST
import com.eimsound.eimusic.jna.windows.structure.WinUserConst.WM_NCMOUSEMOVE
import com.eimsound.eimusic.jna.windows.structure.WinUserConst.WM_NCRBUTTONUP
import com.eimsound.eimusic.jna.windows.structure.WinUserConst.WM_SETTINGCHANGE
import com.eimsound.eimusic.jna.windows.structure.WindowMargins
import com.eimsound.eimusic.jna.windows.structure.isWindows11OrLater
import com.eimsound.eimusic.window.findSkiaLayer
                ...
                if (wParam.toInt() == HTCAPTION) {
                    ...
                    if (menu != null) {
                        ...
                        val menuItemInfo = MENUITEMINFO().apply {
                            cbSize = this.size()
                            fMask = WinUserConst.MIIM_STATE
                            fType = WinUserConst.MFT_STRING
                        }

                        updateMenuItemInfo(menu, menuItemInfo, WinUserConst.SC_RESTORE, isMaximized)
                        updateMenuItemInfo(menu, menuItemInfo, WinUserConst.SC_MOVE, !isMaximized)
                        updateMenuItemInfo(menu, menuItemInfo, WinUserConst.SC_SIZE, !isMaximized)
                        ...
                        updateMenuItemInfo(menu, menuItemInfo, WinUserConst.SC_CLOSE, true)

                        // 设置默认菜单项
                        user32.SetMenuDefaultItem(menu, WinUserConst.WINT_MAX, false)
                        ...
                        // 显示菜单并获取用户选择
                        val ret = user32.TrackPopupMenu(menu, WinUserConst.TPM_RETURNCMD, x, y, 0, hWnd, null)
                        if (ret != 0) {
                            // 发送系统命令
                            user32.PostMessage(
                                hWnd,
...
//                    handleThemeChange()
                ...
                if (uMsg == WM_ACTIVATE) {
                    isWindowActive = wParam.toInt() != WinUserConst.WA_INACTIVE
                }
